...
function Contact() {
  return (
    <Container>
      ...
      <h5 className="text">Github: <a href="https://github.com/TajaMaughan" className="contact-link" target="_blank" rel="noopener noreferrer" >https://github.com/TajaMaughan</a></h5>
      <h5 className="text">LinkedIn: <a href="https://www.linkedin.com/in/mataja-maughan-0ab80316a/" className="contact-link" target="_blank" rel="noopener noreferrer" >https://www.linkedin.com/in/mataja-maughan-0ab80316a/</a></h5>
